...
export const content: ContentItem[] = [
  {
    ...
    content: (
      <div className="h-full w-full rounded-xl relative">
        <Image src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_16.21.35_jtfaxn.jpg" alt="GLUG Team" fill className="object-cover rounded-xl" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full  rounded-xl relative">
        <Image src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_16.23.55_zpdzkp.jpg" alt="GLUG Workshop" fill className="object-cover rounded-xl" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full  rounded-xl relative">
        <Image src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_10.27.30_ugugge.jpg" alt="GLUG Vision" fill className="object-cover rounded-xl" />
      </div>
    ),
  },
];
